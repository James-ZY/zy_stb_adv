DROP TABLE IF EXISTS `ad_default_controller`;
CREATE TABLE `ad_default_controller` (
  ...
  `flag` int(11) NOT NULL DEFAULT '0' COMMENT '0标清 1高清',
  ...
  `ad_network_id`  varchar(64) COLLATE utf8_bin NOT NULL COMMENT '广告商id',
  ...
  PRIMARY KEY (`id`),
   key `ad_default_controller` (`file_path`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='默认图片配置表';