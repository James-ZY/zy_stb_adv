...
(function(e) {
	...
	e.extend(n.prototype, {
		...
		_updateCache: function(e) {
			var left =parseInt($("#beginX").val());
			var top =parseInt($("#beginY").val());
			if(typeof(e.width)!="undefined"){
				$("#endX").val(left+e.width);
			}
			if(typeof(e.height)!="undefined"){
				$("#endY").val(top+e.height);
			}
	...
	e.effects = {
		...
		_refreshItems: function(t) {
			...
			var i, s, n, a, o, r, h, l, u = this.items,
				...
				c = this._connectWith();
			if (c && this.ready) for (i = c.length - 1; i >= 0; i--) for (n = e(c[i]), s = n.length - 1; s >= 0; s--) a = e.data(n[s], this.widgetFullName), a && a !== this && !a.options.disabled && (d.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, {
				item: this.currentItem
