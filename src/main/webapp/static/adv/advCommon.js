                        ...
                        $.each(data,function(commentIndex,comment){
                            ...
                            if(ClassId=="1"){
                                if((comment["time"] !=null && comment["time"]!= "") || comment["time"]==0){
                                    html+='<input type="number" class="pcshowTime" min="1" style="display:none;" max="'+bpTS+'" value="'+comment["time"]+'"></div></li>';
                                }else{
                                ...
                                if((comment["time"] !=null && comment["time"]!= "") || comment["time"]==0){
                                    html+='<input type="number" class="pcshowTime" min="0" style="display:none;" max="600" value="'+comment["time"]+'"></div></li>';
                                }else{
