...
<head>
	<title><spring:message code='icon.select' /></title>
...
<body>
	<div style="position:absolute;right:8px;top:5px;cursor:pointer;" onclick="search();">
		<i class="icon-search"></i><label id="txt"><spring:message code='sys.query' /></label>
	</div>
	<div id="search" class="control-group hide" style="padding:10px 0 0 15px;">
		<label for="key" class="control-label" style="float:left;padding:5px 5px 3px;"><spring:message code='keyword' />：</label>
