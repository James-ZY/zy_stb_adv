...
<%@ page import="com.gospell.aas.common.beanvalidator.BeanValidators"%>
...
<head>
	<title>500 - <spring:message code='system.error'/></title>
	<%@include file="/WEB-INF/views/include/head.jsp" %>
</head>
<body>
	<div class="container-fluid">
		<div class="page-header"><h1><spring:message code='system.error'/></h1></div>
		<p>错误信息：</p><p>
		<%
			if (ex!=null){
