...
<body>
	<form:form id="inputForm" modelAttribute="adControll" action="${ctx}/adv/control/saveNoRedirect" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	 	 ...
	 	 <c:if test="${isNotAdv}">
	 	 	...
	 	 	<div class="controls">
					<form:select path="advertiser.id" class="required">
						<option value="${adControll.advertiser.id}"> <spring:message code='userform.select' /></option>
	 	...
	 	<div class="control-group">
			...
			<div class="controls">
				<form:select path="flag" class="required">
						<option value="${adControll.flag}"> <spring:message code='userform.select' /></option>
		...
		<div class="control-group adType">
			...
			<div class="controls">
				<form:select path="adType.id" id="adType" class="select required">
					<option value="${adControll.adType}"> <spring:message code='userform.select' /></option>
