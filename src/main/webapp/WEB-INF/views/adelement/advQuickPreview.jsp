...
<head>
    ...
    <style type="text/css">
        ...
        .switchResolution input {
            background: url(../../static/images/icon/ic_checkbox_false.png);
        ...
        .switchResolution input[name="1"] {
            background: url(../../static/images/icon/ic_checkbox_ture.png);
        }

        .switchResolution input[name="-1"] {
            background: url(../../static/images/icon/noSelected.png);
        }

        .switchResolution label {
            display: inline-block;
        }
    ...
    <script type="text/javascript">
        ...
        function advReturn() {
            ...
            $("#inputForm").attr("action", "${ctx}/adv/quickAdelement/addreturn");
            $("#inputForm").submit();
            b = false;
            return false;
        }
...
<div class="top_position">
    ...
    <ul>
        ...
        <shiro:hasPermission name="sys:adv:edit">
            <li class="active"><a href="${ctx}/adv/quickAdelement/preview?id=${adelement.id}">
...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/adv/quickAdelement"><spring:message code='adv.list'/></a></li>
    <shiro:hasPermission name="sys:adv:edit">
        <li class="active"><a href="${ctx}/adv/quickAdelement/preview?id=${adelement.id}">
            <spring:message code='adv.preview'/>
        </a></li>
...
<form:form id="inputForm" modelAttribute="adelement" action="${ctx}/adv/quickAdelement/save" method="post"
    ...
    <div class="control-group ad_Preview">
        ...
        <div class="switchResolution">
            <div class="switchItem"><input type="button" id="standardShow"/><label for="standardShow"><spring:message
                    code='adv.standard'/></label></div>
            <div class="switchItem"><input type="button" id="hdShow"/><label for="hdShow"><spring:message
                    code='adv.hd'/></label></div>
        </div>
        <div class="tv_icon">
    ...
    <div class="adinfo_content">
        ...
        <form:hidden path="sdMaxNC"/>
        <form:hidden path="hdMaxNC"/>
        ...
        <form:hidden path="adCombo.oldStatus"/>
        ...
        <form:hidden path="adCombo.sdTrack.id"/>
        <form:hidden path="adCombo.startHour"/>
        <form:hidden path="adCombo.startMinutes"/>
        <form:hidden path="adCombo.startSecond"/>
        <form:hidden path="adCombo.endHour"/>
        <form:hidden path="adCombo.endMinutes"/>
        <form:hidden path="adCombo.endSecond"/>
        <form:hidden path="adCombo.channelIds"/>
        <form:hidden path="adCombo.area"/>
        <form:hidden path="adCombo.selArea"/>
        <form:hidden path="adCombo.selAllArea"/>
        <form:hidden path="adCombo.sendMode"/>
        <form:hidden path="adCombo.sendModeYG"/>
        <form:hidden path="adCombo.trackMode"/>
        <form:hidden path="adCombo.week"/>
        ...
        <input id="validStartTime" name="adCombo.validStartTime" type="hidden" value="${startDate}">
        <input id="validEndTime" name="adCombo.validEndTime" type="hidden" value="${endDate}">
    ...
    <c:if test="${adType.typeId == 2 || adType.typeId == 4 || adType.typeId == 5 || adType.typeId == 10}">
        ...
        <c:if test="${adelement.isFlag == 1 || adelement.isFlag ==2}">
            <div class="control-group control-group-remarks" id="add_text">
                ...
                <div class="controls">
                    <form:textarea path="addText" id="add_text_area" htmlEscape="false" rows="3" maxlength="200"
        ...
        <div style="display:none;">
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="startDate" name="startDate" type="text" maxlength="200"
                           class="input-small Wdate data_content"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="endDate" name="endDate" type="text" maxlength="200"
                           class="input-small Wdate data_content"
    ...
    <div class="form-actions">
        ...
        <shiro:hasPermission name="sys:adv:edit">
            <c:choose>
                <c:when test="${1 == adelement.status || 4 == adelement.status || 3 == adelement.status || 6 == adelement.status }">
                    <input id="btnSubmit" class="btn btn-primary " type="submit"
                           value='<spring:message code='close'/>'/>
                </c:when>
                <c:otherwise>
                    <input id="btnReturnSubmit" class="btn btn-primary " type="button"
                           value='<spring:message code='return'/>' onclick="return advReturn();"/>
