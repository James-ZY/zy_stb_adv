...
<head>
	...
	<script src="${ctx}/static/adv/advPlayRecordChart.js"></script>
	<script combo="text/javascript">
		...
		function createChart(startDate,endDate) {
			...
			$.ajax({
				url:"${ctx}/adv/adStatistic/playChartData?startDate="+startDate+"&endDate="+endDate,
		...
		function getElementDetail(param) {
			layer.open({
				...
				shadeClose:true,
				content: '${ctx}/adv/adStatistic/advPlayChartDetail?advId='+param.data.id+'&startDate='+$("#playStartDate").val()+'&endDate='+$("#playEndDate").val(),
...
<!-- 广告点击统计一级页面 -->
      <div class="top_position">
	    ...
	    <li>></li>
	    <li>
	    	<a href="${ctx}/adv/adStatistic/advPlayRecordChart"><spring:message code='adv.play.chart'/></a>
	     </li>
	     </ul>
    </div>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/adv/adStatistic/advPlayRecordChart"><spring:message code='adv.play.chart' /></a></li>
