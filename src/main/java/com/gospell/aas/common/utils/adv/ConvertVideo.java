...
public class ConvertVideo {
	...
	private static String ffmpegPath = "C:\\Users\\Administrator\\Desktop\\ffmpeg\\bin";
	...
	private static void getPath() { // 先获取当前项目路径，在获得源文件、目标文件、转换器的路径
		...
		try {
			...
			inputPath =   "D:/OTTRaid/content/vod/ffmpeg/123.rmvb";
			outputPath =   "D:/OTTRaid/content/vod/ffmpeg";
		} catch (Exception e) {
	...
	private static String processAVI(int type) {
		...
		command.add("avi");
		command.add("-o");
		command.add(outputPath + "/a367.avi");
		try {  
