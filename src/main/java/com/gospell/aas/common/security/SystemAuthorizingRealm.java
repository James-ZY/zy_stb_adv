...
import com.gospell.aas.common.web.ValidateCodeServlet;
import com.gospell.aas.controller.sys.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	public SystemService getSystemService() {
		if (systemService == null){
			systemService = ApplicationContextHelper.getBean(SystemService.class);
		}
