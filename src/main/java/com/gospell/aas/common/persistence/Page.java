 ...
 */
package com.gospell.aas.common.persistence;
...
public class Page<T> {
    ...
    private String up_page = ApplicationContextHelper.getMessage("up.page");
    private String next_page = ApplicationContextHelper.getMessage("next.page");
    private String current = ApplicationContextHelper.getMessage("current");
    private String total = ApplicationContextHelper.getMessage("total");
    private String items = ApplicationContextHelper.getMessage("items.page");
    private String page = ApplicationContextHelper.getMessage("page");
    private String per_page = ApplicationContextHelper.getMessage("per.page");
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">&#171; "+up_page+"</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+prev+","+pageSize+");\">&#171; "+up_page+"</a></li>\n");
		}
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">"+next_page+"&#187;</a></li>\n");
		} else {
		...
		sb.append("<input type=\"text\" value=\""+pageNo+"\" max=\""+last+"\" onblur=\" ");
		sb.append(funcName+"(this.value>"+last+"?"+last+":this.value,"+pageSize+");\" onclick=\"this.select();\"/> / ");
		sb.append("<input type=\"text\" value=\""+last+"\" readonly=\"readonly\"/> "+page+" ");
		sb.append("&nbsp;&nbsp;&nbsp;"+per_page+" ");
		sb.append("<input type=\"text\" value=\""+pageSize+"\" onblur=\" ");
		sb.append(funcName+"("+pageNo+",this.value);\" onclick=\"this.select();\"/>"+items+"，");
		sb.append(total +"&nbsp;"+ count +"&nbsp;"+items+(message!=null?message:"")+"</a><li>\n");
...
//	}
    ...
    public int getFirstResult() {
        ...
        /*if (getCount() >=0 && firstResult >= getCount()) {
            firstResult = 0;
        }*/
        return firstResult;
    }
