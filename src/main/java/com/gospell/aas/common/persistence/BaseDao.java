...
import com.gospell.aas.common.utils.ReflectHelper;
...
public class BaseDao<T> {
    ...
    public <E> Page<E> findBySqlToDistinct(Page<E> page, String sqlString, Parameter parameter, Class<?> resultClass,String distinct) {
        return findBySqlToDistinct(page, sqlString, parameter, resultClass, null,distinct);
    }
    /**
     * 统计需要去重的sql
     * @param page
     ...
     * @return
     */
    public <E> Page<E> findBySqlToDistinct(Page<E> page, String sqlString, Parameter parameter, Class<?> resultClass, ResultTransformer rtf,String distinct) {
        // get count
    	
        if (!page.isDisabled() && !page.isNotCount()) {
            String countSqlString = "select count( distinct " +distinct+")"  + removeSelect(removeOrders(sqlString));
        ...
        List<E> dataList = query.list();
        page.setList( dataList);
        return page;
    }

    public <E> Page<E> findBySql(Page<E> page, String sqlString, Parameter parameter, Class<?> resultClass, ResultTransformer rtf) {
        // get count
    ...
    public <E> List<E> findBySql(String sqlString, Parameter parameter, Class<?> resultClass, ResultTransformer rtf) {
