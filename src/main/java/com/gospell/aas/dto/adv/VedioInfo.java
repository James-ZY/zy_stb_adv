...
public class VedioInfo {
	...
	public static final String H264= ICodec.ID.CODEC_ID_H264.name();
	public static final String MPEG2TS= ICodec.ID.CODEC_ID_MPEG2TS.name();
	public static final String MPEG2VIDEO= ICodec.ID.CODEC_ID_MPEG2VIDEO.name();
	
	public static final String AAC= ICodec.ID.CODEC_ID_AAC.name();
