...
public class Office extends IdEntity<Office> {
	...
	private Area area;		// 归属区域(保留)
	private String code; 	// 级别编码
	private String name; 	// 用户级别名称
	private String type; 	// 级别类型
	private String grade; 	// 级别等级（1公司2广告运营商 3广告商 4）
	...
	//用户等级
	public static final String GRADE_COMPANY="1";
	public static final String GRADE_OPERATOR="2";
	public static final String GRADE_ADVERTISER="3";
	
	private List<User> userList = Lists.newArrayList();   // 拥有用户列表
	private List<Office> childList = Lists.newArrayList();// 拥有子列表
	...
	// 机构等级
	public static final String GRADE_1 = "1";  // 运营管理
	public static final String GRADE_2 = "2";  // 广告运营商
	public static final String GRADE_3 = "3";  // 广告商
}